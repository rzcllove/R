...
var vm = new Vue({
    ...
    methods: {
        ...
        add: function(){
            vm.showList = false;
            vm.title = "新增";
            vm.menu = {parentName:null,parentId:0,type:1,orderNum:0,state:1};
            vm.getMenu();
        },
        update: function () {
...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '状态', field: 'type', align: 'center', valign: 'middle', sortable: true, width: '100px', formatter: function(item, index){
...
$(function () {
    ...
    var table = new TreeTable(Menu.id, baseURL + "sys/menu/Menulist", colunms);
