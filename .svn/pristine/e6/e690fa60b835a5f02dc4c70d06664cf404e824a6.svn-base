...
import top.rzclk.common.utils.Constant.MenuType;
import top.rzclk.modules.sys.dao.SysMenuDao;
...
public class SysMenuServiceImpl implements SysMenuService {
	...
	public List<SysMenuEntity> queryListMenu(Map<String, Object> map) {
		return sysMenuDao.queryListMenu(map);
	}
	@Override
	...
	public void update(SysMenuEntity menu) {
		if(menu.getState()==0){
			sysMenuDao.updateBatch(0L,menu.getMenuId());
		}else if(menu.getState()==1){
			sysMenuDao.updateBatch(1L,menu.getMenuId());
		}
	...
	@Override
	public Long getDetpOpen() {
		return sysMenuDao.getDetpOpen();
	}
