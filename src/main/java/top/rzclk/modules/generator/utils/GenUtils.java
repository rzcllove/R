package top.rzclk.modules.generator.utils;
...
import top.rzclk.common.utils.DateUtils;
import top.rzclk.modules.generator.entity.ColumnEntity;
import top.rzclk.modules.generator.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		map.put("classname", tableEntity.getClassname());
		map.put("pathName", "sys/"+tableEntity.getClassname().toLowerCase());
	...
	public static Configuration getConfig(){
		try {
			...
			config = genUtils.NullInit(config);
			return config;
//			throw new RException("获取配置文件失败，", e);
	...
	public static String getFileName(String template, String className, String packageName){
		...
		if(template.contains("list.html.vm")){
			return "main" + File.separator + "resources" + File.separator + "views" + File.separator
					+ "modules" + File.separator + "sys" + File.separator + className.toLowerCase() + ".html";
		}
		
		if(template.contains("list.js.vm")){
			return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js" + File.separator
					+ "modules" + File.separator + "sys" + File.separator + className.toLowerCase() + ".js";
		}
	 ...
	 * @return 为空初始化
	 */
	public Configuration NullInit(Configuration config){
		config.setProperty("tablePrefix", "tb_");
		...
		config.setProperty("decimal", "BigDecimal");
		config.setProperty("bit", "Boolean");
		config.setProperty("char", "String");
		config.setProperty("varchar", "String");
		config.setProperty("tinytext", "String");
		...
		config.setProperty("datetime", "Date");
		config.setProperty("timestamp", "Date");
		config.setProperty("package", "top.rzclk.modules.sys");
		config.setProperty("author", "wangk");
		config.setProperty("email", "rzcllove@163.com");
		return config;
